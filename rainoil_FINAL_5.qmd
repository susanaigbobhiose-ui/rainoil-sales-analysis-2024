---
title: "Price Sensitivity, Seasonality, and Sales Performance Across Rainoil Retail Outlets: An Exploratory and Inferential Analysis of 2024–2025 Fuel Sales Data"
...
Nigeria's downstream petroleum retail sector is characterised by price volatility, seasonal demand swings, and growing regional competition. Rainoil Limited operates one of Nigeria's largest independent retail fuel networks, with 193 service stations spanning all six geopolitical zones. As Strategy and Business Development Manager, this analysis was conducted to answer three interconnected strategic questions critical to guiding the Retail Sales team's planning for 2026: *(1) Do pump price variations across stations and over time significantly explain differences in PMS (petrol) and AGO (diesel) sales volumes? (2) Does seasonality — specifically Nigeria's rainy season, dry season, and festive periods — independently drive volume fluctuations beyond what price alone explains? (3) Which station and area characteristics are associated with top retail performance?*

Using five analytical techniques applied to **193 stations across 24 months** (January 2024 – December 2025, yielding 4,632 station-month observations), this report finds:

1. **Network structure:** Sales volumes are highly right-skewed — a small cluster of mega-stations accounts for a disproportionate share of national retail volume, while the 14 stations newly commissioned in 2025 show strong ramp-up trajectories.
2. **Price sensitivity confirmed:** PMS price is negatively correlated with PMS volume. The regression estimates that a ₦100 increase in pump price is associated with approximately an 8–10% reduction in monthly PMS volume per station, holding all other factors constant.
3. **Seasonality is independently significant:** Even after controlling for price, rainy season months (April–October) suppress PMS volumes — particularly in South-South stations where flooding disrupts road access and reduces traffic. This is a structural, weather-driven effect that price management cannot offset.
4. **Festive periods generate measurable demand surges:** December (Christmas/New Year) and April (Easter) produce statistically significant volume spikes above what price and season alone predict, consistent with holiday travel and increased generator fuel demand.
5. **Zone matters structurally:** South-West and South-South zones significantly out-sell Northern zones (ANOVA, p < 0.05), reflecting population density, commercial intensity, and road traffic density — not just pricing differences.
6. **2025 showed recovery:** The year-on-year paired analysis indicates whether the network recovered volume in 2025 as the market adjusted to post-subsidy price levels.

**Primary recommendation for the Retail Sales team (2026):** Deploy a seasonally-aware, zone-differentiated retail strategy — adjusting pump pricing within competitive thresholds during price-sensitive periods, pre-positioning additional stock ahead of festive surges, and reducing supply loading to flood-prone South-South stations during peak rainy months (June–September) while redirecting capacity to South-West and Northern stations.
...
**Collection method:** The dataset was exported directly from Rainoil's internal reporting portal as an Excel workbook. Data is compiled monthly by the Retail Operations team from station-level daily meter readings submitted by station managers across all 21 operational areas.
